...
## Project Structure
    ...
    ├── testapiautostorybo_125521  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_125521`
...
2. Clone this repo and `cd testapiautostorybo_125521`
